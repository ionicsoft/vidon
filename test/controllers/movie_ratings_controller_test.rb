...
class MovieRatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movie_rating" do
    assert_difference('MovieRating.count') do
      post movie_ratings_url, params: { movie_rating: { movie_id: @movie_rating.movie_id, rating: @movie_rating.rating } }
    end
  ...
  test "should update movie_rating" do
    patch movie_rating_url(@movie_rating), params: { movie_rating: { movie_id: @movie_rating.movie_id, rating: @movie_rating.rating } }
