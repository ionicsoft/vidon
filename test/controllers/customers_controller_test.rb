...
class CustomersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should get rentals" do
    log_in_as_customer
    click_on 'My Rentals'
    assert_selector "h3", text: "My Rentals"
  end
  ...
  test "should get friends" do
    ...
    click_on 'Friends'
    assert_selector "h3", text: "Your friends"
  end
  ...
  test "should get profile" do
    ...
    click_on @customer.person.first_name
    click_on 'Profile'
    assert_selector "h4", text: @customer.person.full_name
  end
  ...
  test "should get movie tab" do
    ...
    click_on 'Browse'
    click_on 'Movies'
    assert_selector "h5", text: @movie.video.title
  end
  ...
  test "should cancel subscription" do
    ...
    assert_text "This subscription will not renew"
  end
  ...
  test "should play rental" do
    ...
    click_on 'My Rentals'
    click_on 'Play'
    assert_selector "h3", text: @movie.video.title
  end
  ...
  test "should see friends" do
    ...
    click_on @customer.person.first_name
    click_on 'Friends'
    assert_selector "h4", text: @customer2.person.full_name
  end
  ...
  test "should search for people" do
    ...
    assert_selector "h5", text: @customer2.person.full_name
  end
  ...
  test "should get customer from comment" do
    ...
    assert_selector "h4", text: @comment.commentor.person.full_name
  end
  ...
  test "should get movie from favorites" do
    ...
    assert_selector "h4", text: @fav.content.video.title
  end
  ...
  test "should get episode from favorites" do
    ...
    assert_selector "h3", text: @fav2.content.video.title
  end
  ...
  test "should watch episode from subscription" do
    ...
    click_on 'Episode list'
    click_on 'Watch'
    assert_selector "h3", text: @episode.video.title
  end
